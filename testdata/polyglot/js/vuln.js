...
app.get('/ping', (req, res) => {
  ...
  // PLANT: OS command injection via exec with concatenated input (CWE-78)
...
app.get('/calc', (req, res) => {
  ...
  // PLANT: Arbitrary code execution via eval (CWE-95)
  try {
...
app.get('/greet', (req, res) => {
  ...
  // PLANT: Reflected XSS via unescaped user input in HTML response (CWE-79)
